...
function Ecosystem(numAgents) {
    ...
    for (let i = 0; i < numAgents; i++) {
        this.critters.push(new Critter(this.critterCount, {god: "August", primary: this.conduit.getRandomTarget(this.conduit), secondary: this.conduit.getRandomTarget(this.conduit)}));
        this.critterCount++;
    }
}

Ecosystem.prototype.run = (e) => {
    let updates = {
        supply: [],
        critters: [],
        corpses: []
