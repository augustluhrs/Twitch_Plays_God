...
// Critter.prototype.die = () => {
//     Ecosystem.die(this);
// }

Critter.prototype.display = () => {
    let isReadyToMate = false;
    if(this.mateTimer <= 0 && this.lifeForce >= this.minLifeToReproduce){
        isReadyToMate = true;
    }

    return {x: this.position.x, y: this.position.y, r: this.r, color: this.color, life: this.lifeForce, isReadyToMate: isReadyToMate};
}
